 ...
 * @version    $Id: MangoPayBankDetail.php 2015-05-11 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitestoreproduct_Form_MangoPayBankDetail extends Engine_Form {

    public function init() {
        parent::init();

        $this->setTitle(sprintf(Zend_Registry::get('Zend_Translate')->translate('MangoPay Bank Account Configuration')));
        $this->setName('sitestoreproduct_payment_info_mangopay_bank_detail');
