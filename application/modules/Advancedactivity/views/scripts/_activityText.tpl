                  ...
                  <?php $shareIcons = $this->shareIcons($action) ?>
                    <?php if ($shareIcons) : ?>
                      <li class="feed_item_option_share seao_icons_toolbar_attach"> 
                        <?php echo $shareIcons; ?> 
                        <a href="" class='share_icons_link'><?php echo $this->translate('ADVACADV_SHARE')?></a>
                        <span>&#183;</span>
                      </li>
                    <?php endif; ?>
                  <?php else: ?>
                      ...
                      <li>
                        ...
                        <div class="comments_likes">
                          ...
                          <?php if ($action->likes()->getLikeCount() <= 3 || $this->viewAllLikes): ?>
                            <?php if ($this->allowReaction): ?>
                              <?php $likeS = '%s reacted on this.'; $likeP = '%s react this.'; ?>
                            <?php else: ?>
                          ...
                          <?php else: ?>
                          <?php if ($this->allowReaction): ?>
                            <?php $likeS = '%s person reacted on this'; $likeP = '%s people react this' ?>
                            <?php $url =  $this->url(array('action' => 'likes', 'module' => 'sitereaction',
                              ...
                              <?php else: ?>
                            <?php $likeS = '%s person likes this'; $likeP = '%s people like this' ?>
                            <?php $url = $action->getSubject()->getHref(array('action_id' => $action->action_id, 'show_likes' => true));
                            $class = '';
                            ?>
                          <?php endif; ?>
                          <?php
