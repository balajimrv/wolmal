...
class Advancedactivity_Form_Admin_Global extends Engine_Form {
    ...
    public function init() {
        ...
        $this->addElement('Radio', 'advancedactivity_post_byajax', array(
            ...
            'description' => "Do you want to enable posting of status updates via AJAX? (Note: Select 'No' if you have either enabled Janrain Integration with 'Publish' feature or are using Social DNA Publisher plugin. Status updates from LinkedIn tab will always be via AJAX, even if you select No over here.)?",
            'multiOptions' => array(
                1 => 'Yes',
                0 => 'No'
            ),
