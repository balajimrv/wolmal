...
class Zephyrtheme_Widget_HeaderMenuController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
	...
	$this->view->minimenushow_profileimg = $minimenushow_profileimg = Engine_Api::_()->getApi('settings', 'core')->getSetting('zephyr.minimenushow_profileimg', false);
	$this->view->minimenushow_logout = $minimenushow_logout = Engine_Api::_()->getApi('settings', 'core')->getSetting('zephyr.minimenushow_logout', false);
  }
