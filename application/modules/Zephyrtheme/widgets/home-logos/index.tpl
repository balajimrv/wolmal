...
<div class="layout_theme_home_logos"><div <?php echo $width_forwide; ?>>
  <ul>
    ...
    <li><a href="<?php echo ($this->feat1_link) ? $this->feat1_link : 'javascript:void(0)'; ?>" <?php echo ($this->feat_linktarget) ? 'target="_blank"' : ''; ?>>
    ...
    <li><a href="<?php echo ($this->feat2_link) ? $this->feat2_link : 'javascript:void(0)'; ?>" <?php echo ($this->feat_linktarget) ? 'target="_blank"' : ''; ?>>
    ...
    <li><a href="<?php echo ($this->feat3_link) ? $this->feat3_link : 'javascript:void(0)'; ?>" <?php echo ($this->feat_linktarget) ? 'target="_blank"' : ''; ?>>
    ...
    <li><a href="<?php echo ($this->feat4_link) ? $this->feat4_link : 'javascript:void(0)'; ?>" <?php echo ($this->feat_linktarget) ? 'target="_blank"' : ''; ?>>
    ...
    <li><a href="<?php echo ($this->feat5_link) ? $this->feat5_link : 'javascript:void(0)'; ?>" <?php echo ($this->feat_linktarget) ? 'target="_blank"' : ''; ?>>
    ...
    <li><a href="<?php echo ($this->feat6_link) ? $this->feat6_link : 'javascript:void(0)'; ?>" <?php echo ($this->feat_linktarget) ? 'target="_blank"' : ''; ?>>
