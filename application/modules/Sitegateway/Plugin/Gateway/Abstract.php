...
abstract class Sitegateway_Plugin_Gateway_Abstract extends Engine_Payment_Plugin_Abstract {
    ...
    public function createEventBillTransaction($event_id, $bill_id, $params = array()) {
        ...
        $sitegatewayStripTransaction = Zend_Registry::isRegistered('sitegatewayStripTransaction') ? Zend_Registry::get('sitegatewayStripTransaction') : null;
        if (!empty($sitegatewayStripTransaction))
            return $this->createResourceBillTransaction($event_id, $bill_id, $params);
    }
    ...
    public function createStoreBillTransaction($store_id, $bill_id, $params = array()) {
        ...
        $sitegatewayStripTransaction = Zend_Registry::isRegistered('sitegatewayStripTransaction') ? Zend_Registry::get('sitegatewayStripTransaction') : null;
        if (!empty($sitegatewayStripTransaction))
            return $this->createResourceBillTransaction($store_id, $bill_id, $params);
    }
    ...
    public function onResourceIpn($order) {
