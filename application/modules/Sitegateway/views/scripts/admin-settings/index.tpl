...
<script type="text/javascript">
    ...
    window.addEvent('domready', function () {
        ...
        paypalAdaptivePayment = ($('sitegateway_paypaladaptivepaymentmethod-split').checked) ? 'split' : 'escrow';
        changeText(paypalAdaptivePayment);
    ...
    function changeText(method) {
        splitEle = $('sitegateway_paypaladaptivepaymentmethod-escrow');
        label = splitEle.getNext();
        if (method == 'escrow') {
