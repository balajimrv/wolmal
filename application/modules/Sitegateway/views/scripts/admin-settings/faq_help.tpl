...
<div class="admin_seaocore_files_wrapper">
    ...
    <ul class="admin_seaocore_files seaocore_faq">
        ...
        <li>
            ...
            <div class='faq' style='<?php echo $style; ?>' id='faq_<?php echo $flag; ?>'>
               This plugin currently supports Stripe, Stripe connect, PayPal Adaptive, Mangopay, PayUmoney and Paynow payment gateways. If you want to integrate a new payment gateway, then please <a href="http://www.socialengineaddons.com/contact" target="_blank">contact us</a> for same.
            </div>
        </li>
        ...
        <li>
            ...
            <div class='faq' style='<?php echo $style; ?>' id='faq_<?php echo $flag; ?>'>
                ...
                PayPal Adaptive: <a href="https://developer.paypal.com/docs/classic/products/adaptive-payments/" target="_blank">https://developer.paypal.com/docs/classic/products/adaptive-payments</a><br />
        ...
        <li>
            <a href="javascript:void(0);" onClick="faq_show('faq_<?php echo ++$flag; ?>');">Why I am unable to see MangoPay and PayPal Adaptive payment gateways for purchasing the package?</a>
            <div class='faq' style='<?php echo $style; ?>' id='faq_<?php echo $flag; ?>'>
                Both MangoPay and PayPal Adaptive payment gateways divide payment between site owner and seller (in both payment methods: Split Immediately and Escrow.) But, in case of ‘Packages’ the amount is charged by site owner only. So, there is no need to divide the payment and hence MangoPay and PayPal Adaptive payment gateways cannot be used for purchasing the package.
            </div>
        </li> 
        <li>
            <a href="javascript:void(0);" onClick="faq_show('faq_<?php echo ++$flag; ?>');">How can I use Split Immediately payment method of PayPal Adaptive Payment Gateway?</a>
            <div class='faq' style='<?php echo $style; ?>' id='faq_<?php echo $flag; ?>'>
                Please refer below video to configure Split Immediately payment method of PayPal Adaptive payment gateway with Stores / Marketplace - Ecommerce Plugin.<br />
                <a href="https://www.youtube.com/watch?v=4dfndx9Y7Js" target="_blank">https://www.youtube.com/watch?v=4dfndx9Y7Js</a>
    ...
    <ul class="admin_seaocore_files seaocore_faq"> 
        ...
        <li>
            <a href="javascript:void(0);" onClick="faq_show('faq_<?php echo ++$flag; ?>');">Can you please recommend to me, how can I decide to use Stripe / Stripe Connect for SocialEngineAddOns plugins installed on my website ?</a>
            <div class='faq' style='<?php echo $style; ?>' id='faq_<?php echo $flag; ?>'>
    ...
    <ul class="admin_seaocore_files seaocore_faq"> 
        <br />
        <h3>PayPal Adaptive</h3>
        <li>
            <a href="javascript:void(0);" onClick="faq_show('faq_<?php echo ++$flag; ?>');">In case of PayPal Adaptive, refund process is failing for the products in the stores on my site. What might be the reason?</a>
            <div class='faq' style='<?php echo $style; ?>' id='faq_<?php echo $flag; ?>'>
                In case of PayPal Adaptive, refund process will only work when primary receiver is site owner.
                [Note: To make site owner as primary receiver, go to Advanced Payment Gateways / Stripe Connect /  PayPal Adaptive  Plugin → Global Settings.]
            </div>
        </li>  
        <li>
            <a href="javascript:void(0);" onClick="faq_show('faq_<?php echo ++$flag; ?>');">In case of PayPal Adaptive, is it possible for Store owners to initiate the refund process for their products?</a>
            <div class='faq' style='<?php echo $style; ?>' id='faq_<?php echo $flag; ?>'>
                Yes, it is possible for Store owners to initiate the refund process for their products, in case of PayPal Adaptive. Site owner needs to give the Store owner permission by adding him as a ‘Third Party’ from <a target="_blank" href='https://www.paypal.com/?cmd=_profile-api-list-auths' >here</a>.
                [Note: Site owner needs to add himself also as third party to be able to initiate the refund process.]
            </div>
        </li> 
        <li>
            <a href="javascript:void(0);" onClick="faq_show('faq_<?php echo ++$flag; ?>');">How can I configure PayPal Adaptive payment gateway in Split Immediately payment method for ‘Stores / Marketplace - Ecommerce Plugin’?</a>
            <div class='faq' style='<?php echo $style; ?>' id='faq_<?php echo $flag; ?>'>
        ...
        <li>
            <a href="javascript:void(0);" onClick="faq_show('faq_<?php echo ++$flag; ?>');">What is the difference between PayPal and PayPal Adaptive payment gateways?</a>
            <div class='faq' style='<?php echo $style; ?>' id='faq_<?php echo $flag; ?>'>
               PayPal is a simple payment gateway which requires more involvement of Admin. There is also delay in payment transfer into admin and seller’s account.<br />
            Whereas PayPal Adaptive offers two types of payment methods: Split Immediately and Escrow. This requires less involvement of Admin. For Split Immediately payment method, there is a real time payment transfer into sellers and admin accounts. For Escrow payment method, site admin / seller can hold the payment till 90 days.
            </div>
        </li> 
    </ul>  <br/>
    <ul class="admin_seaocore_files seaocore_faq"> 
