...
document.getElementById('email-error').innerHTML = '';
    ...
    jQuery(function($) {   
      ...
      $('form').submit(function(e) {       
        ...
        if(cardType=='visa')
          $('#cc-number').addClass('visa');
        if(cardType=='mastercard')
          $('#cc-number').addClass('mastercard');
        if(cardType=='american express')
          $('#cc-number').addClass('amex');
        if(cardType=='discover')
        $('#cc-number').addClass('discover');
        if(cardType=='jcb')
        $('#cc-number').addClass('jcb');
        if(cardType=='dinersclub')
        $('#cc-number').addClass('diners');
        ...
        if($('.validation').hasClass('text-success'))
        {
          ...
          var card_exp_year =$('.cc-exp').val().split('/')[1];
          var card_exp_year=card_exp_year.replace(" ","");
          var card_exp_month =$('.cc-exp').val().split('/')[0];
