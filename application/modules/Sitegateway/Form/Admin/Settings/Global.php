...
class Sitegateway_Form_Admin_Settings_Global extends Engine_Form {
    ...
    public function init() {
        ...
        $this->addElement('Radio', 'sitegateway_paypaladaptivepaymentmethod', array(
            'label' => "PayPal Adaptive's Payment Method",
            'multioptions' => array(
                'split' => 'Split Immediately',
                'escrow' => 'Escrow',
            ),
            'onclick' => 'javascript:changeText(this.value)',
            'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegateway.paypaladaptivepaymentmethod', 'split'),
        ));
//        $this->addElement('Radio', 'sitegateway_paypaladaptiveprimaryreceiver', array(
//            'label' => "PayPal Adaptive's Primary Receiver",
//            'description' => "Who will be the primary receiver for the payment done through PayPal Adaptive?",
//            'multioptions' => array(
//                1 => 'Seller',
//                2 => 'Site Owner',
//            ),
//            'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegateway.paypaladaptiveprimaryreceiver', 1),
//        ));
        $this->addElement('Radio', 'sitegateway_paypaladaptivechangemethod', array(
            'label' => "PayPal Adaptive's Fees",
            'description' => "Who will pay PayPal Adaptive's fees for payments processing?",
            'multioptions' => array(
                1 => 'Primary receiver',
                2 => 'Secondry receiver',
                3 => "Each receiver [Note:PayPal Adaptive's Fees will be divided between the primary and secondary receiver on the basis of transaction amount.]"
            ),
            'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegateway.paypaladaptivechangemethod', 1),
        ));
