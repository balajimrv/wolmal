<h2> <?php echo $this->translate("Total FB/EB/BB values") ?> </h2>
...
$totalFB = ($FB_value - $this->redeemCount);

?>
<b style="font-weight: bold;font-size: 26px;">Total FB count: <?php echo $totalFB; ?></b><br>
<b style="font-weight: bold;font-size: 26px;">Total EB count: <?php echo $EB_value; ?></b><br>
