<h2>
  <?php echo $this->translate("Manual BB") ?>
</h2>
  ...
  <table class='admin_table'>
    <thead>
      <tr>
        ...
        <th style='width: 10%;' class='admin_table_centered'><?php echo $this->translate("BB") ?></th>
        <th style='width: 10%;' class='admin_table_centered'><?php echo $this->translate("Month-Year") ?></th>
      ...
      <?php if( count($this->paginator) ): ?>
        <?php foreach( $this->paginator as $item ):
          ...
          <tr>
            ...
            <td class="admin_table_centered nowrap">
              <?php echo Engine_Api::_()->sescustomize()->getUserBridges($item->user_id, 'bbmonth');?>
            </td>
            ...
            <td class='admin_table_options'>
              <a class='smoothbox' href='<?php echo $this->url(array('action' => 'addbb', 'id' => $item->user_id));?>'>
                <?php echo $this->translate("Add BB") ?>
              </a>
            </td>
          </tr>
        <?php endforeach; ?>
