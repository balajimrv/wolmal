        ...
        function updateValues() {
          ...
          if(sesJqueryObject('#sessmoothbox_main').length){
           ...
           // var textAreal = $(domInput);
            ...
            /*if(!str.match(/(http|ftp|https):\/\/[\w-]+(\.[\w-]+)?#([a-zA-Z0-9]+)/g) && !str.match(/(http|ftp|https):\/\/[\w-]+(\.[\w-]+)?@([a-zA-Z0-9]+)/g) && !str.match(/(http|ftp|https):\/\/[\w-]+(\.[\w-]+)?#([\u0600-\u06FF]+)/g) && !str.match(/(http|ftp|https):\/\/[\w-]+(\.[\w-]+)?@([\u0600-\u06FF]+)/g)) {console.log('1');
              if(!str.match(/#(([a-zA-Z0-9]+)|([\u0600-\u06FF]+))#/g)) {console.log('2'); //arabic support
