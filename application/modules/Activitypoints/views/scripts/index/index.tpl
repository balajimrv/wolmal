...
<div><?php echo $this->translate('100016706') ?></div>
...
<div style="padding-left: 10px;">
  ...
  <div class='activitypoints_vault_balance'>
    <div class='activitypoints_vault_balance_title'>
      <strong>Balance Bridges</strong> <br>
    </div>
    ...
    <div class='activitypoints_vault_balance_text'>
      <span id='userpoints_balance'><?php echo $this->user_points ?></span> <?php echo $this->translate('100016708') ?>
    </div>
    <br>
...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function(){
    ...
    <div id="up_sendpoints_success" style="display:none;">
      <img src='application/modules/Activitypoints/externals/images/success.gif' border='0'>
        <span id="up_sendpoints_success_inner"></span>
    </div>
    
    <div id="up_sendpoints_fail" style="display:none;">
      <img src='application/modules/Activitypoints/externals/images/error.gif' border='0'>
    ...
    <div id="up_sendpoints_progress" style="display:none;">
        ...
        <tr><td><img src="application/modules/Activitypoints/externals/images/semods_ajaxprogress1.gif"></td><td style="padding-left:5px"><?php echo $this->translate('100016719') ?></td></tr>
        </table>
    </div>
    ...
    <div id="up_sendpoints_main" style="display:block">
        ...
        <tr>
          <td>
            <span style="font-weight: bold"> <?php echo $this->translate('100016710') ?> </span> 
          </td>
          <td class='activitypoints_browse_field'>

			<div id="to-wrapper" <?php if( isset($this->toUser) && $this->toUser->getIdentity() ): ?>style="display:none;"<?php endif; ?>>
			  <div id="to-element">
        ...
        <tr>
          <td>
            <span style="font-weight: bold"> <?php echo $this->translate('100016711') ?> </span>
          </td>
          <td class='activitypoints_browse_field'>
        ...
        <tr>
          ...
          <td class='browse_field'>
            <button class="button" onclick="up_sendpoints()"> <?php echo $this->translate('100016715') ?> </button>
        </td>
        </tr>
...
<?php endif; ?>
  ...
  <div class="activitypoints_vault_total">
    <div class="activitypoints_vault_total_title">
      <strong>Total Bridges Gained</strong> <br>
    </div>
    
    <img class="activitypoints_vault_total_coin" src="application/modules/Activitypoints/externals/images/userpoints_coins32.png">
    <div class="activitypoints_vault_total_text">
      <strong> <?php echo $this->user_points_totalearned ?> </strong> <?php echo $this->translate('100016708') ?>
    </div>
  </div>
...
<div class="activitypoints_vault_bottom">
  ...
  <div class="activitypoints_vault_rating">
    <div class="activitypoints_vault_rating_title">
      <strong> <?php echo $this->translate('100016722') ?> </strong> <br>
    </div>
