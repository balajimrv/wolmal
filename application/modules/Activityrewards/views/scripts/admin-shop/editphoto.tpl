...
<h2>
  <a href="<?php echo $this->url(array('module'  => 'activitypoints', 'controller' => 'settings','action'=>'index'), 'admin_default',true) ?>"><?php echo $this->translate("Activity Points Plugin") ?></a> &raquo; <a href="<?php echo $this->url(array('module'  => 'activityrewards', 'controller' => 'shop','action'=>'index'), 'admin_default',true) ?>"><?php echo $this->translate("Shop") ?></a> &raquo; <?php echo $this->translate("Edit Offer Photo") ?>
</h2>
