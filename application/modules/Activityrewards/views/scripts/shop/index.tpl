...
<div class="headline">
  <h2>
    <?php echo $this->translate('Bridges Shop');?>
  </h2>
  <div class="tabs">
    <?php
      // Render the menu
...
<div class='layout_middle'>
  ...
  <?php if( $this->tag ): ?>
    <h3>
      <?php echo $this->translate('Showing offers using the tag');?> #<?php echo $this->tag_text;?> <a href="<?php echo $this->url(array(), 'activityrewards_spend', true) ?>">(x)</a>
    </h3>
  <?php endif; ?>
