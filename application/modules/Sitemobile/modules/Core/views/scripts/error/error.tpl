 ...
 * @version    $Id: error.tpl 9800 2012-10-17 01:16:09Z richard $
 * @author     John
 */
/**
 * @category   Application_Core
...
<div>
  ...
  <p>
    <?php
    echo $this->translate('We are currently experiencing some technical ' .
            'issues. Please try again or report this to your site administrator ' .
            'using the %1$scontact%2$s form.', '<a href="javascript:void(0);" onclick="goToContactPageAfterError();return false;">', '</a>'
    )
    ?>
  </p>
  <br />
