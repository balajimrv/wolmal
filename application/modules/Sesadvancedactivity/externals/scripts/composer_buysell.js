...
Composer.Plugin.Buysell = new Class({
  ...
  activate : function() {
    ...
    var price = '<div class="sesact_sell_composer_price"><span class="sesact_sell_composer_price_currency">'+this.options.currency+'</span><span class="sesact_sell_composer_price_input"><input type="text" id="buysell-price" placeholder="'+ en4.core.language.translate("Add price")+'" name="buysell-price"></span></div>';
    var location = '<div class="sesact_sell_composer_location"><i class="sesbasic_text_light fa fa-map-marker"></i><span id="locValuesbuysell-element"></span><span id="buyselllocal"><input type="text" id="buysell-location" placeholder="'+ en4.core.language.translate("Add location (optional)")+'" name="buysell-location"><input type="hidden" name="activitybuyselllng" id="activitybuyselllng"><input type="hidden" name="activitybuyselllat" id="activitybuyselllat"></span></div>';
    ...
    sesJqueryObject(this.elements.body).html(title+price+location+description);
