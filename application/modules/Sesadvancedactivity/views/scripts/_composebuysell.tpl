...
?>
<?php $this->headScript()
    ->appendFile($this->layout()->staticBaseUrl . 'application/modules/Sesadvancedactivity/externals/scripts/composer_buysell.js');
 
 $this->headTranslate(array(
		'What are you selling?', 'Add price', 'Add location (optional)', 'Describe your item (optional)', 'Choose a file to upload', 'Upload smaller file.'));     ?>
...
<?php $fullySupportedCurrencies = Engine_Api::_()->sesbasic()->getSupportedCurrency();
  ...
  en4.core.runonce.add(function() {
    composeInstance.addPlugin(new Composer.Plugin.Buysell({
      ...
      photoUpload: "<?php echo Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sesalbum') || Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('album') ?>",
      lang : {
