...
function hideShowNetworkPrivacySettings(value){
 valueSelectedPrivacy = value;
 if(value == 1){
    document.getElementById('sesadvancedactivity_allownetworkprivacytype-wrapper').style.display = 'block';		
  }else{
    document.getElementById('sesadvancedactivity_allownetworkprivacytype-wrapper').style.display = 'none';
  }
}
...
hideShowNetworkPrivacySettings(<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sesadvancedactivity.allownetworkprivacy', 1); ?>);
function hideShowPrivacySettings(value){
  if(value == 1){
			document.getElementById('sesadvancedactivity_allownetworkprivacy-wrapper').style.display = 'block';		
			document.getElementById('sesadvancedactivity_allownetworkprivacytype-wrapper').style.display = 'block';	
      document.getElementById('sesadvancedactivity_allowlistprivacy-wrapper').style.display = 'block';	
      hideShowNetworkPrivacySettings(valueSelectedPrivacy);
		}else{
			document.getElementById('sesadvancedactivity_allownetworkprivacy-wrapper').style.display = 'none';	
      document.getElementById('sesadvancedactivity_allownetworkprivacytype-wrapper').style.display = 'none';	
...
showinstagram(<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sesadvancedactivity.instagram.enable', 0); ?>);
...
function showinstagram(value) {
  if(value == 1) {
    if($('sesbasic_instagram_clientid-wrapper'))
      $('sesbasic_instagram_clientid-wrapper').style.display = 'block';
    if($('sesbasic_instagram_clientsecret-wrapper'))
      $('sesbasic_instagram_clientsecret-wrapper').style.display = 'block';
    if($('sesadvancedactivity_instagramtext-wrapper'))
      $('sesadvancedactivity_instagramtext-wrapper').style.display = 'block';
    if($('sesadvancedactivity_instagramicon-wrapper'))
      $('sesadvancedactivity_instagramicon-wrapper').style.display = 'block';
    if($('sesadvancedactivity_photoshowcount-wrapper'))
      $('sesadvancedactivity_photoshowcount-wrapper').style.display = 'block';
  } else {
    if($('sesbasic_instagram_clientid-wrapper'))
      $('sesbasic_instagram_clientid-wrapper').style.display = 'none';
    if($('sesbasic_instagram_clientsecret-wrapper'))
      $('sesbasic_instagram_clientsecret-wrapper').style.display = 'none';
    if($('sesadvancedactivity_instagramtext-wrapper'))
      $('sesadvancedactivity_instagramtext-wrapper').style.display = 'none';
    if($('sesadvancedactivity_instagramicon-wrapper'))
      $('sesadvancedactivity_instagramicon-wrapper').style.display = 'none';
    if($('sesadvancedactivity_photoshowcount-wrapper'))
      $('sesadvancedactivity_photoshowcount-wrapper').style.display = 'none';
  }
