...
<a href="javascript:;" class="sesact_addbday_close close_parent_notification_sesadv"><i class="fa fa-close sesbasic_text_light"></i></a>
  <?php 
  ...
  <div class="sesact_sendwish_btns">
    	<a href="<?php echo $birthdayuser->getHref(); ?>"><i class="fa fa-pencil-square-o"></i><span><?php echo $this->translate("Post on Wall"); ?></span></a>
