...
en4.core.runonce.add(function() {
    if (Composer.Plugin.AdvancedactivityPhoto)
      return;
    Asset.javascript('<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sesadvancedactivity/externals/scripts/composer_photo.js', {
      onLoad:  function() {
        var type = 'wall';
...
function createStatusbar(obj,file)
{
     ...
     if(rowCount %2 ==0) row ="even";
		  var checkedId = sesJqueryObject("input[name=cover]:checked");
			...
			this.option = sesJqueryObject('<div class="sesalbum_upload_item_options clear sesbasic_clearfix"><span class="sesalbum_upload_item_radio"></span><a class="delete_image_upload" href="javascript:void(0);"><i class="fa fa-close"></i></a></div>').appendTo(this.objectInsert);
