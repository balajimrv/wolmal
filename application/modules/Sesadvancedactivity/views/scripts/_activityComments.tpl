        ...
        <ul class="sesbasic_clearfix">
          ...
          <?php if( $action->getTypeInfo()->shareable && $this->viewer()->getIdentity() ): ?>
            ...
            <?php elseif( $action->getTypeInfo()->shareable == 2 ): ?>
              <li class="feed_item_option_share">
              	<a href="<?php echo $this->url(array('module' => 'sesadvancedactivity', 'controller' => 'index', 'action' => 'share', 'type' => $subject->getType(), 'id' => $subject->getIdentity(), 'format' => 'smoothbox'), 'default', true);?>" class="smoothbox">
                	<i></i>
                  <span><?php echo $this->translate('Share');?></span>
                </a>
            ...
            <?php elseif( $action->getTypeInfo()->shareable == 4 ): ?>
              <li class="feed_item_option_share">
              	<a href="<?php echo $this->url(array('module' => 'sesadvancedactivity', 'controller' => 'index', 'action' => 'share', 'type' => $action->getType(), 'id' => $action->getIdentity(), 'format' => 'smoothbox'), 'default', true);?>" class="smoothbox">
                	<i></i>
                  <span><?php echo $this->translate('Share');?></span>
                </a>
                ...
                <li id="comment-<?php echo $comment->comment_id ?>">
                  ...
                  <div class="comments_info">
                   ...
                   <span class="sesact_comments_delete">
                     <?php echo $this->htmlLink(array('route'=>'default', 'module'    => 'sesadvancedactivity', 'controller'=> 'index', 'action' => 'delete', 'action_id' => $action->action_id, 'comment_id'=> $comment->comment_id,), $this->translate(''), array('title', $this->translate("delete"), 'class' => 'smoothbox fa fa-close')) ?>
                   </span>
                    <?php endif; ?>
