          ...
          <div class="sesact_sellitem_popup_item_info sesbasic_clearfix">
            ...
            <?php if($locationBuySell){ ?>            
              <div class="sesact_sellitem_popup_item_location sesbasic_text_light">
                ...
                <span><a href="<?php echo $this->url(array('resource_id' => $this->item->getIdentity(),'resource_type'=>$this->item->getType(),'action'=>'get-direction'), 'sesbasic_get_direction', true); ?>" onClick="openSmoothBoxInUrl(this.href);return false;"><?php echo $locationBuySell->venue; ?></a></span>
              </div>
            <?php } ?>
            ...
            <div class="sesact_sellitem_popup_item_button">
              ...
              <?php if($action->subject_id != $this->viewer()->getIdentity()){ ?>
                <button onClick="openSmoothBoxInUrl('sesadvancedactivity/ajax/message/action_id/<?php echo $action->getIdentity(); ?>');return false;"><i class="fa fa-commenting"></i><?php echo $this->translate("Message Seller"); ?></button>
              <?php }else{ ?>
