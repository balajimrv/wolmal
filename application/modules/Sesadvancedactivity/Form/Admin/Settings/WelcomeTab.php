...
class Sesadvancedactivity_Form_Admin_Settings_WelcomeTab extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Radio', 'sesadvancedactivity_makelandingtab', array(
      ...
      'description' => 'Do you want to make this tab as the landing tab of advanced news & activity feeds on your website?',
      'multiOptions' => array(
    ...
    if(!Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sesalbum')) {
      ...
      $albumplugin = '<a href="https://www.socialenginesolutions.com/social-engine/advanced-photos-albums-plugin/" target="_blank">Advanced Photos & Albums Plugin</a>';

      $description = sprintf('Do you want to enable members to upload their profile photos via AJAX from this tab, if they have still not uploaded? [This will encourage users to upload their photos quickly and easily without reloading the page. This setting is dependent on our "%s".]', $albumplugin);
    } else {
