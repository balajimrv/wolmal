			...
			<ul class="edit-button">
				<li>
					...
					<ul class="seaocore_profile_options_pulldown">
						...
						<li>
							<?php echo $this->htmlLink($this->url(array('action' => 'get-albums-photos', 'user_id' => $this->user->user_id, 'recent' => 1), 'siteusercoverphoto_profilepage', true), $this->translate('Choose from Albums'), array(' class' => 'seaocore_profile_cover_icon_photo_view smoothbox')); ?>
						</li>
						<?php if (!empty($this->user->user_cover) && $this->photo) : ?>
