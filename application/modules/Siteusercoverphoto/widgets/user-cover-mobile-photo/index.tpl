...
<div data-role="popup" id="icons_options_cover_photo<?php echo $randId?>" <?php echo $this->dataHtmlAttribs("popup_content", array('data-theme' => "c")); ?> data-tolerance="15" data-overlay-theme="a" data-theme="none" aria-disabled="false" data-position-to="window" >
	...
	<?php if (Engine_Api::_()->sitemobile()->isApp()) : 
	 echo $this->htmlLink($this->url(array('action' => 'get-albums-photos', 'user_id' => $this->user->user_id, 'recent' => 1, 'format' => 'smoothbox'), 'siteusercoverphoto_profilepagemobile', true), $this->translate('Choose from Albums'), array(' class' => 'ui-btn-default ui-btn-corner-all')); 
        else:
             echo $this->htmlLink($this->url(array('action' => 'get-albums-photos', 'user_id' => $this->user->user_id, 'recent' => 1), 'siteusercoverphoto_profilepagemobile', true), $this->translate('Choose from Albums'), array(' class' => 'ui-btn-default ui-btn-corner-all')); 
        endif;
?>
