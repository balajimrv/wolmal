...
//    $curr_module_version = strcasecmp($is_enabled->version, $SocialEngineAddOns_version);        
      ...
      $shouldUpgrade = checkVersion_siteusercoverphoto($running_version,$product_version);
...
function checkVersion_siteusercoverphoto($databaseVersion, $checkDependancyVersion) {
    $f = $databaseVersion;
