...
JS;
        ...
        {
            $baseUrl = $view->hecoreBaseUrl();
            $view->headLink()->appendStylesheet($baseUrl . 'application/modules/Hecore/externals/styles/main.css');
            $module = Engine_Api::_()->getDbtable('modules', 'core');
            if ($module->isModuleEnabled('offers')) {
                $view->headLink()->appendStylesheet($baseUrl . 'application/modules/Offers/externals/styles/main.css');
            }
            if ($module->isModuleEnabled('heevent')) {
                $view->headLink()->appendStylesheet($baseUrl . 'application/modules/Heevent/externals/styles/main.css');
            }
