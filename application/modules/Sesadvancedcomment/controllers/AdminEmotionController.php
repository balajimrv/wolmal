...
class Sesadvancedcomment_AdminEmotionController extends Core_Controller_Action_Admin
{
  public function indexAction()
  {
    ...
    $this->view->subNavigation = Engine_Api::_()->getApi('menus', 'core')
            ->getNavigation('sesadvancedcomment_admin_emotion_setting_main', array(), 'sesadvancedcomment_admin_main_emotionssettingsmain');
  ...
  public function galleryAction()
  {
    ...
    $this->view->navigation = Engine_Api::_()->getApi('menus', 'core')
            ->getNavigation('sesadvancedcomment_admin_main', array(), 'sesadvancedcomment_admin_main_emotionssettings');
    $this->view->subNavigation = Engine_Api::_()->getApi('menus', 'core')
            ->getNavigation('sesadvancedcomment_admin_emotion_setting_main', array(), 'sesadvancedcomment_admin_main_emotiongallery');
    $page = $this->_getParam('page',1);
