...
<?php if( count($this->paginator) ): ?>
  ...
  <div>
     <div class="sesbasic_search_reasult">
     	<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesadvancedcomment', 'controller' => 'emotion', 'action' => 'gallery'), $this->translate("Back to Sticker Packs"), array('class'=>'sesbasic_button fa fa-long-arrow-left')); ?>
