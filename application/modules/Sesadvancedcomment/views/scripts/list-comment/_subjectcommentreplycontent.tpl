...
<?php } ?>
   <?php echo $this->getCommentContent($commentreply->body) ?>
    <?php 
   ...
   <span class="comments_reply_body_actual" rel="" data-subject="<?php echo $commentreply->resource_type; ?>" data-subjectid="<?php echo $commentreply->resource_id; ?>" style="display:none;"><?php echo $commentreply->body; ?></span>
<?php 
...
?>
 <?php if($commentreply->emoji_id){ ?>
    <div class="comment_image emoji">
        <?php 
          $photo = Engine_Api::_()->getItem('sesadvancedcomment_emotionfile',$commentreply->emoji_id);
          if($photo){ 
