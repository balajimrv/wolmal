...
<?php } ?>
   ...
   <span class="comments_body_actual" rel="" data-subject="<?php echo $comment->resource_type; ?>" data-subjectid="<?php echo $comment->resource_id; ?>" style="display:none;"><?php echo $comment->body; ?></span>
    <?php 
     if($comment->file_id){ ?>
