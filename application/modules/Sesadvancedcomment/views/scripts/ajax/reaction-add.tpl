...
<div class="sesact_reaction_add_cnt ses_emoji_store sesbasic_bxs">
    ...
    <div class="ses_emoji_store_header sesbasic_clearfix" style="background-image:url(<?php echo $this->storebackgroundimage?>)">
      <div class="ses_emoji_store_header_cont">
        <div class="ses_emoji_store_header_cont_title centerT">
          <i class="fa fa-shopping-cart "></i>
          <span><?php echo $this->translate($this->storepopupTitle); ?></span>
        </div>
        <div class="ses_emoji_store_header_cont_des sesbasic_text_light centerT"><?php echo $this->translate($this->storepopupDesciption); ?></div>
      </div>
    </div>
